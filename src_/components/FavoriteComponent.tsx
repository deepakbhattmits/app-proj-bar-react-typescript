...
const Favorite:FC<IProp> = ({ fBeers, umarkFav }):JSX.Element => {
	...
	const renderFav = () => {
		...
		return (
			Object.values(fBeers as any[])?.map(({id,name,tagline,description,image_url}:{id:string,name:string,tagline:string,description:string,image_url:string},i:number) =>
